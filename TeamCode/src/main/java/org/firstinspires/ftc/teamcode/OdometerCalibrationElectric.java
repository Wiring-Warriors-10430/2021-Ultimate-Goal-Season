...
@TeleOp(name="Odometry Calibration 2: Electric Boogaloo", group="aaRobot2")
public class OdometerCalibrationElectric extends OpMode {
    ...
    File wheelBaseSeparationFile = AppUtil.getInstance().getSettingsFile("wheelBaseSeparation2.txt");
    File horizontalTickOffsetFile = AppUtil.getInstance().getSettingsFile("horizontalTickOffset2.txt");
